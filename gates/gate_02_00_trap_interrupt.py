...
# Directed-sim artifacts (wave.vcd / sim.log / firmware.disasm) are generated by the phase
# Makefile; absent in a fresh checkout. Skip (not-run), don't fail — regenerate via the phase.
