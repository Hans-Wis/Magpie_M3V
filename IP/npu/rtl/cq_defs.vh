...
localparam [7:0] CSR_MAT_A_ADDR = 8'h60;
localparam [7:0] CSR_MAT_B_ADDR = 8'h64;
localparam [7:0] CSR_MAT_CTRL = 8'h68;
localparam [7:0] CSR_MAT_MULT = 8'h6C;
localparam [7:0] CSR_MAT_RSP = 8'h70;
