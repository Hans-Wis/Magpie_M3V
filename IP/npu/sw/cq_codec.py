...
ERR_CAUSES = {'BAD_OPCODE': 1, 'RSVD_VIOLATION': 2, 'RING_OVERRUN': 3, 'ENGINE_NOT_READY': 4, 'DMA_FAULT': 5, 'DESC_ALIGN': 6}
CSR_OFFSETS = {'CQ_RING_BASE': 64, 'CQ_RING_SIZE': 68, 'CQ_HEAD': 72, 'CQ_TAIL': 76, 'CQ_CTRL': 80, 'CQ_STATUS': 84, 'ERR_CAUSE': 88, 'CQ_EVENT': 92}
