...
ERR_CAUSES = {'BAD_OPCODE': 1, 'RSVD_VIOLATION': 2, 'RING_OVERRUN': 3, 'ENGINE_NOT_READY': 4, 'DMA_FAULT': 5, 'DESC_ALIGN': 6, 'MAT_PARAM': 7}
CSR_OFFSETS = {'CQ_RING_BASE': 64, 'CQ_RING_SIZE': 68, 'CQ_HEAD': 72, 'CQ_TAIL': 76, 'CQ_CTRL': 80, 'CQ_STATUS': 84, 'ERR_CAUSE': 88, 'CQ_EVENT': 92, 'MAT_A_ADDR': 96, 'MAT_B_ADDR': 100, 'MAT_CTRL': 104, 'MAT_MULT': 108, 'MAT_RSP': 112, 'MAT_CLAMP': 116, 'MAT_OUT_BASE': 120, 'MAT_STATUS': 124}
...
def encode(op, **fields):
    ...
    if opv == OPCODES['MAT_ACC_CLR']:
        return [w0, fields.get('acc_mask', 0) & 0xFFFFFFFF, 0, 0]
