...
Asserts the committed baseline report (dv/coverage/verilator/codecov_report.json,
...
REPORT = ROOT / "dv/coverage/verilator/codecov_report.json"
...
def test_report_exists():
    assert REPORT.exists(), "run dv/coverage/verilator/run_cov.sh to generate the baseline"
