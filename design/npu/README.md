# design/npu — Magpie_M3V net-new NPU domain (cpu_m1-derived, loosely-coupled over AXI)
...
`design/cpu_m1/` is the **frozen M1A scalar core** (tag `m1a-rtl-freeze-v1.0`) — the *host / main CPU*,
