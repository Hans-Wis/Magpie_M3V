...
module axi_full_arbiter_2x1 (
    ...
    output wire        m0_rvalid,  input  wire m0_rready,  output wire [31:0] m0_rdata,
    ...
    input  wire        m0_wvalid,  output wire m0_wready,  input wire [31:0] m0_wdata,
    input  wire [3:0]  m0_wstrb,   input wire m0_wlast,
    ...
    output wire        m1_rvalid,  input  wire m1_rready,  output wire [31:0] m1_rdata,
    ...
    input  wire        m1_wvalid,  output wire m1_wready,  input wire [31:0] m1_wdata,
    input  wire [3:0]  m1_wstrb,   input wire m1_wlast,
    ...
    input  wire        s_rvalid,  output wire s_rready, input wire [31:0] s_rdata,
    ...
    output wire        s_wvalid,  input  wire s_wready, output wire [31:0] s_wdata,
    output wire [3:0]  s_wstrb,   output wire s_wlast,
