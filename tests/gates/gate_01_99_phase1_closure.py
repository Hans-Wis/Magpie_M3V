...
PHASE1_GATES = {
    "pipeline_reference": "tests/gates/gate_10_pipeline_v2_reference.py",
    "fetch_rv32c_prefetch": "tests/gates/gate_01_01_fetch_rv32c_prefetch.py",
    "decode_execute_rv32imc": "tests/gates/gate_01_02_decode_execute_rv32imc.py",
    "pipeline_hazard": "tests/gates/gate_01_03_pipeline_hazard.py",
    "bp_ras_redirect": "tests/gates/gate_01_04_bp_ras_redirect.py",
    "phase1_closure": "tests/gates/gate_01_99_phase1_closure.py",
}
...
def test_phase1_state_records_closure_and_non_qualification():
    ...
    assert metrics["phase_01_99_phase1_closure_gate"] == "tests/gates/gate_01_99_phase1_closure.py"
