#!/usr/bin/env python3
"""Compare mem-wrapper random program commits with Spike under random-wait DUT trace."""
...
def main() -> int:
    ...
    ok, message = compare_commits(dut, spike, label="mem-wrapper lockstep")
    (ROOT / "mem_wrapper_lockstep_report.md").write_text(
        "# Phase 2.1 mem_wrapper lockstep report\n\n"
