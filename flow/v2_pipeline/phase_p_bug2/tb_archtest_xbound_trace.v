...
module tb_archtest_xbound_trace;
    reg         clk = 1'b0;
    reg         resetn = 1'b0;
    ...
    initial begin
        ...
        $dumpvars(0, dut.if_pc, dut.next_pc_w, dut.pc_redirect, dut.redirect_target,
                     dut.redirect_warmup, dut.warmup, dut.any_stall,
                     dut.cur_at_high, dut.cur_half_lo, dut.cur_half_hi,
                     dut.is_comp_lo, dut.is_comp_hi, dut.is_16bit_w,
                     dut.at_cross_boundary, dut.upcoming_cross, dut.consecutive_cross,
                     dut.cross_assemble, dut.residue, dut.instr_assembled,
                     dut.if_ex_pc, dut.if_ex_instr, dut.if_ex_valid, dut.if_ex_is_16bit,
                     dut.ex_wb_pc_r, dut.ex_wb_instr_r, dut.ex_wb_valid_r,
                     dut.wb_instr_retired, dut.rfu_we, dut.rfu_wr_idx, dut.rfu_wr_data);
