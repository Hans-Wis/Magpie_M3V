...
~000015     wire is_system = (opcode == `OPC_SYSTEM);
...
%000000                 default            : alu_op = `ALU_SEQ;
                    endcase
~000329         end else if (is_lui) begin
...
~000287             is_jal, is_jalr: wb_sel = `WB_SEL_PC4;   // pc + 4 (link)
~000047             is_load        : wb_sel = `WB_SEL_LSU;
~000016             is_csr         : wb_sel = `WB_SEL_CSR;   // csr_rdata (lab05)
