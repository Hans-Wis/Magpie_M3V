...
%000000     reg [31:0] mepc_reg;
%000000     reg [31:0] mcause_reg;
...
%000000     wire [31:0] mstatus_val = {24'b0, mstatus_mpie, 3'b0, mstatus_mie, 3'b0};
%000000     wire [31:0] mie_val     = {20'b0, mie_meie, 11'b0};
%000000     wire [31:0] mip_val     = {20'b0, ext_pending, 11'b0};
...
%000000                     `CSR_MIE     : mie_meie    <= new_val[`MIE_MEIE_BIT];
...
%000000             if (trap_enter) begin
%000000                 mepc_reg     <= trap_pc;
%000000                 mcause_reg   <= `MCAUSE_EXT_IRQ;
%000000                 mstatus_mpie <= mstatus_mie;
%000000                 mstatus_mie  <= 1'b0;
