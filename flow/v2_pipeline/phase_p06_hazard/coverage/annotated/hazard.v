//      // verilator_coverage annotation
        ...
        module hazard (
            // ID/EX stage 狀態
%000002     input         id_valid,
 000256     input  [ 4:0] id_rs1_idx,
 000258     input  [ 4:0] id_rs2_idx,
 000145     input         id_is_muldiv,
        
            // EX/MEM stage (新加，lab06b 4-stage 用)
%000003     input         em_valid,
%000009     input         em_rd_we,
 000257     input  [ 4:0] em_rd_idx,
 000020     input         em_is_load,
        
            // EX/WB stage (lab06 同款，但 load forward OK 不用 stall)
 000531     input         wb_valid,
 000530     input         wb_rd_we,
 000529     input  [ 4:0] wb_rd_idx,
 000531     input         wb_is_load,
        
            // M-unit 狀態
 000273     input         md_busy,
 ...
 000034     wire load_use_match_em = (id_rs1_idx == em_rd_idx) || (id_rs2_idx == em_rd_idx);
 000017     wire load_use_stall = id_valid && em_valid && em_is_load && em_rd_we &&
            ...
            // ---- Muldiv ----
 000073     wire muldiv_stall = id_valid && id_is_muldiv && md_busy;
